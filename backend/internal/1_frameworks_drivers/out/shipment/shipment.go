...
// NewToShipment ...
func NewToShipment() gateways.ToShipment {
	s := new(Shipment)
	return s
}

// PutProducts ...
func (s *Shipment) PutProducts(ctx context.Context, order *entities.Order) error {
...
// WriteLog ...
func (s *Shipment) WriteLog(ctx context.Context, order *entities.Order) error {
