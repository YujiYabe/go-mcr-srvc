...
var allergyList = []map[string]string{
	allergyListJa,
	allergyListEn,
	allergyListEs,
	allergyListZh,
...
func GetAllergyList() []map[string]string {
	return allergyList
}

// https://www.relief.jp/docs/001403.html
var allergyListJa = map[string]string{
...
func GetAllergyListJa() map[string]string {
	return allergyListJa
}

var allergyListEn = map[string]string{
...
var allergyListEs = map[string]string{
...
var allergyListZh = map[string]string{
...
var allergyListAr = map[string]string{
