...
例えばキッチンのスタッフが入れ替わっても、レジの人は気にせずキッチンへのオーダーを通すだけですが、これはclean architectureの疎結合に似ています。


# この記事のターゲット
clean architectureについて解説してる有用な記事はたくさんありますが、clean architecture自体が難しい概念なので中々理解できない方が対象です。
そんなこと言いながらも、わたしもよくわからなくなることがあります！てへぺろ
...
# 最後に
うーん。よく見るとハンバーガーのバンズ/レタス/パティ/トマト/バンズ もclean architectureなんですかね。

疲れてるのかclean architectureがゲシュタルト崩壊してきました。(clean architecture初心者にありがち)
